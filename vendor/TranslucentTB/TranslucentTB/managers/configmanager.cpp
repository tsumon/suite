...
{
	static constexpr std::string_view COMMENT = "// See https://TranslucentTB.github.io/config for more information\n";
	static constexpr std::wstring_view SCHEMA = L"https://TranslucentTB.github.io/settings.schema.json";
